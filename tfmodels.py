...
class CNN:
    def __init__(self, input_length, batch_size=32, output_size=2, filter_length=50, hidden_size=128, kernel_size=2):
        self.model = Sequential()
        self.model.add(Input(batch_shape=(batch_size, input_length)))
